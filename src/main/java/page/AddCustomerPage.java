...
public class AddCustomerPage extends BasePage{
	...
	@FindBy(how = How.XPATH, using = "//input[@name='city']") WebElement CITY_FIELD_LOCATOR;
	@FindBy(how = How.XPATH, using = "//input[@name='state']") WebElement STATE_FIELD_LOCATOR;
	@FindBy(how = How.XPATH, using = "//input[@name='zip']") WebElement ZIP_FIELD_LOCATOR;
